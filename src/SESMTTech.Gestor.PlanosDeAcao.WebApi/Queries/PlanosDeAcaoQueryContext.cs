...
{
    internal class PlanosDeAcaoQueryContext
    {
        private readonly IDbConnection dbConnection;
        private readonly PlanosDeAcaoSqlConfiguration coreBusinessSqlConfiguration;

        public string DatabaseName => coreBusinessSqlConfiguration?.DatabaseName;

        public PlanosDeAcaoQueryContext(PlanosDeAcaoSqlConfiguration coreBusinessSqlConfiguration)
        {
